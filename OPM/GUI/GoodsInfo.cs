...
namespace OPM.GUI
{
    public partial class GoodsInfo : Form
    {
        ...
        private void BtnBack_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtContractGoodsUnitPrice.Text.Trim()) || txtContractGoodsUnitPrice.Text.Trim() == "0" || string.IsNullOrEmpty(txtContractGoodsQuantity.Text.Trim()) || txtContractGoodsQuantity.Text.Trim() == "0")
            {
                DialogResult dialogResult = MessageBox.Show("Bạn chưa nhập thông tin giá trị đơn hàng trước VAT. Bạn chắc chắn vẫn muốn thoát?","Thông báo",MessageBoxButtons.YesNo);

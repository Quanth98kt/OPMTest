...
namespace OPM.GUI
{
    public partial class SiteInfo : Form
    {
        ...
        void AddSiteBinding()
        {
            ...
            txtSiteId.DataBindings.Add(new Binding("Tag", dtgvSiteA.DataSource, "SiteId"));
        ...
        void LoadDataGridView(string SiteId)
        {
            ...
            AddSiteBinding();
            txtSiteId.Tag = txtSiteId.Text.Trim();
        ...
        private void btnAddOrUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (SiteObj.SiteANames(txtSiteName.Text.Trim()) && txtSiteId.Text.Trim() != txtSiteId.Tag.ToString())
            {
                MessageBox.Show("Tên đơn vị đã tồn tại!");
                return;
            }

            if (SiteObj.SiteExist(txtSiteId.Tag.ToString()) || SiteObj.SiteExist(txtSiteId.Text.Trim()))
            {
                site.SiteUpdate(txtSiteId.Text.Trim(), txtSiteId.Tag.ToString());
                MessageBox.Show("Cập nhật thành công thông tin đơn vị!");
            }
            else
            {
                site.SiteInsert(txtSiteId.Text.Trim());
                MessageBox.Show("Tạo mới thành công thông tin đơn vị!");
            }
        ...
        {
            if (OPMEnginee.SiteObj.SiteExist(txtSiteId.Tag.ToString()))
            {
                OPMEnginee.SiteObj.Delete(txtSiteId.Tag.ToString());
        ...
        private void btn_new_Click(object sender, EventArgs e)
        {
            ...
            (Tag as OPMDASHBOARDA).OpenSiteAForm("XXXXXXXX".ToString());
        }
    }
}

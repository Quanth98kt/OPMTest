    ...
    public partial class PLInfo : Form
    {
        ...
        private void buttonAddSerial_Click(object sender, EventArgs e)
        {
            ...
            if (ofd.ShowDialog() == DialogResult.OK)
            {
                ...
                DataTable plTable = OpmExcelHandler.ReadExcelToDataTable(path, 3, 1, 1);
        ...
        private void txtCaseQuantity_TextChanged(object sender, EventArgs e)
        {
            try
            {
                (Tag as OPMDASHBOARDA).Pl.CaseQuantity = int.Parse(txtCaseQuantity.Text.Trim());
            }
            catch
            {
                MessageBox.Show("Nhập Quantity/Case dạng số!");
            }
        }
    }
}

...
namespace OPM.GUI
{
    public partial class DeliveryPlanInfo : Form
    {
        ...
        private void btnClose_Click(object sender, EventArgs e)
        {
            ...
            {
                if (DialogResult.No == MessageBox.Show("Vẫn chưa phân bổ hết PO, bạn chắc chắn muốn thoát ?", "Cảnh báo!", MessageBoxButtons.YesNo, MessageBoxIcon.Question)) return;
                (Tag as OPMDASHBOARDA).OpenPOForm();
            }
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn chưa nhập thông tin đơn vị hoặc số lượng!");
            }
        }

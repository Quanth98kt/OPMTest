...
namespace OPM.OPMWordHandler
{
    class OpmWordHandler
    {
        ...
        public static string Temp39_POAdjustmentConfirmation(string poid)
        {
            ...
            object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 39. Công văn xác nhận điều chỉnh đơn hàng {2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 37. Biên bản xác nhận cài đặt License vào hệ thống.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                ...
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 37. Biên bản xác nhận cài đặt License vào hệ thống_{2}.docx", contract.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
                object missing = Missing.Value;
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 36. Biên bản nghiệm thu License.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                //NTKT_Thanh ntkt = new NTKT_Thanh(id);
                POObj po = new POObj(poid);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 36. Biên bản nghiệm thu License_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
                myDoc = wordApp.Documents.Open(ref path, ref missing, ref readOnly,
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 33. Văn bản đề nghị mở BLBH PO.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            {
                POObj po = new POObj(poid);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 33. Văn bản đề nghị mở BLBH PO_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 30. Biên bản thanh lý hợp đồng.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                ...
                object filename = string.Format(@"D:\OPMTest\{0}\Mẫu 30. Biên bản thanh lý hợp đồng {0}.docx", contract.ContractId.Trim().Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 29. Biên bản xác nhận khối lượng hoàn thành.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            {
                ContractObj contract = new ContractObj(contractId);
                object filename = string.Format(@"D:\OPMTest\{0}\Mẫu 29. Biên bản xác nhận khối lượng hoàn thành {0}.docx", contract.ContractId.Trim().Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 28. Biên bản nghiệm thu bàn giao hàng hóa.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            {
                POObj po = new POObj(poid);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 28. Biên bản nghiệm thu bàn giao hàng hóa_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
                ...
                for(int n = 0;n<list.Count;n++)
                {
                    if (list[n].PODeliveryProgressRemainingQuantity == 0)
                    {
                        if(list[n].PODeliveryProgressLastDeliveredDate <= list[n].PODeadline)
                        {
                            ...
                            wordApp.Visible = false;
                            Word.Document myDoc = null;
                            path = @"D:\OPMTest\Template\Mẫu 26. Biên bản xác nhận tiến độ_Đúng hạn.docx";
                            if (!File.Exists(path.ToString()))
                            {
                                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                                return;
                            }
                            filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 26. Biên bản xác nhận tiến độ_Đúng hạn_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), list[n].PODeliveryProgressVNPTName.Replace('/', '-'));
                            //object isVisible = false;
                        ...
                        else
                        {
                            ...
                            wordApp.Visible = false;
                            Word.Document myDoc = null;
                            path = @"D:\OPMTest\Template\Mẫu 26. Biên bản xác nhận tiến độ_Chậm tiến độ.docx";
                            if (!File.Exists(path.ToString()))
                            {
                                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                                return;
                            }
                            filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 26. Biên bản xác nhận tiến độ_Chậm tiến độ_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), list[n].PODeliveryProgressVNPTName.Replace('/', '-'));
                            //object isVisible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 25. Đề nghị phát hoá đơn cho các viễn thông tỉnh theo PO.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            {
                POObj po = new POObj(poid);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 25. Đề nghị phát hoá đơn cho các viễn thông tỉnh theo PO_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 24. Giấy chứng nhận chất lượng từ nhà máy tổng hợp PO.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                //NTKT_Thanh ntkt = new NTKT_Thanh(id);
                POObj po = new POObj(poid);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 24. Giấy chứng nhận chất lượng từ nhà máy tổng hợp PO_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 23. Giấy chứng nhận chất lượng tổng hợp PO.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                //NTKT_Thanh ntkt = new NTKT_Thanh(id);
                POObj po = new POObj(poid);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 23. Giấy chứng nhận chất lượng tổng hợp PO_{2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 22. Mẫu phiếu bảo hành.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                ...
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\DP{2}\Mẫu 22. Mẫu phiếu bảo hành_{3}.docx", pl.ContractId.Trim().Replace('/', '-'), pl.POName.Replace('/', '-'), pl.DPId.Replace('/', '-'), pl.VNPTId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 20. Giấy chứng nhận chất lượng gửi tỉnh.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                PLObj pl = new PLObj(PLId);
                SiteObj vnpt = new SiteObj(pl.VNPTId);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\DP{2}\Mẫu 20. Giấy chứng nhận chất lượng gửi tỉnh_{3}.docx", pl.ContractId.Trim().Replace('/', '-'), pl.POName.Replace('/', '-'), pl.DPId.Replace('/', '-'), pl.VNPTId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 19. Giấy chứng nhận chất lượng từ nhà máy gửi tỉnh.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                PLObj pl = new PLObj(PLId);
                SiteObj vnpt = new SiteObj(pl.VNPTId);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\DP{2}\Mẫu 19. Giấy chứng nhận chất lượng từ nhà máy gửi tỉnh_{3}.docx", pl.ContractId.Trim().Replace('/', '-'), pl.POName.Replace('/', '-'), pl.DPId.Replace('/', '-'), pl.VNPTId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 18.  Biên bản giao nhận hàng hóa.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                PLObj pl = new PLObj(PLId);
                SiteObj vnpt = new SiteObj(pl.VNPTId);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\DP{2}\Mẫu 18.  Biên bản giao nhận hàng hóa_{3}.docx", pl.ContractId.Trim().Replace('/', '-'), pl.POName.Replace('/', '-'), pl.DPId.Replace('/', '-'),pl.VNPTId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 11. Biên bản nghiệm thu kỹ thuật.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            try
            {
                ...
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\NTKT{2}\Mẫu 11. Biên bản nghiệm thu kỹ thuật_{3}.docx", ntkt.ContractId.Trim().Replace('/', '-'), ntkt.POName.Replace('/', '-'), ntkt.NTKTPhase, ntkt.NTKTId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
                ...
                //Tạo file BLHĐ trong thư mục D:\OPM
                string folder = string.Format(@"D:\OPMTest\{0}\{1}\NTKT{2}", ntkt.ContractId.Trim().Replace('/', '-'), ntkt.POName.Replace('/', '-'), ntkt.NTKTPhase);
                Directory.CreateDirectory(folder);
                myDoc.SaveAs2(ref filename, ref missing, ref missing, ref missing,
                                ref missing, ref missing, ref missing,
                                ref missing, ref missing, ref missing,
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 10. Chứng nhận bản quyền phần mềm.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            {
                NTKTObj ntkt = new NTKTObj(ntktId);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\NTKT{2}\Mẫu 10. Chứng nhận bản quyền phần mềm_{3}.docx", ntkt.ContractId.Trim().Replace('/', '-'), ntkt.POName.Replace('/', '-'), ntkt.NTKTPhase, ntkt.NTKTId.Replace('/', '-'));
                object missing = Missing.Value;
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 9. Biên bản kiểm tra kỹ thuật.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            {
                NTKTObj ntkt = new NTKTObj(ntktId);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\NTKT{2}\Mẫu 9. Biên bản kiểm tra kỹ thuật_{3}.docx", ntkt.ContractId.Trim().Replace('/', '-'), ntkt.POName.Replace('/', '-'), ntkt.NTKTPhase, ntkt.NTKTId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 8. Đề nghị nghiệm thu kỹ thuật.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
            ...
            {
                NTKTObj ntkt = new NTKTObj(ntktId);
                object filename = string.Format(@"D:\OPMTest\{0}\{1}\NTKT{2}\Mẫu 8. Đề nghị nghiệm thu kỹ thuật_{3}.docx", ntkt.ContractId.Trim().Replace('/', '-'), ntkt.POName.Replace('/', '-'), ntkt.NTKTPhase, ntkt.NTKTId.Replace('/', '-'));
                object readOnly = true;
                //object isVisible = false;
                wordApp.Visible = false;
        ...
        {
            POObj po = new POObj(poid);
            object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 6. Văn bản đề nghị tạm ứng đơn hàng {2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
            object path = @"D:\OPMTest\Template\Mẫu 6. Văn bản đề nghị tạm ứng đơn hàng.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
        ...
        {
            POObj po = new POObj(poid);
            object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 5. Văn bản mở bảo lãnh tạm ứng đơn hàng {2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
            object path = @"D:\OPMTest\Template\Mẫu 5. Văn bản mở bảo lãnh tạm ứng đơn hàng.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
        ...
        {
            POObj po = new POObj(poid);
            object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 4. Đề nghị bảo lãnh thực hiện hợp đồng cho đơn hàng {2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
            object path = @"D:\OPMTest\Template\Mẫu 4. Văn bản mở bảo lãnh thực hiện đơn hàng.docx";
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
        ...
        {
            POObj po = new POObj(poid);
            object path = @"D:\OPMTest\Template\Mẫu 3. Văn bản xác nhận hiệu lực đơn hàng.docx";
            object filename = string.Format(@"D:\OPMTest\{0}\{1}\Mẫu 3. Văn bản xác nhận hiệu lực đơn hàng {2}.docx", po.ContractId.Trim().Replace('/', '-'), po.POName.Replace('/', '-'), po.POId.Replace('/', '-'));
            if (!File.Exists(path.ToString()))
            {
                MessageBox.Show(string.Format(@"Không tìm thấy {0}", path.ToString()));
                return string.Format(@"Không tìm thấy {0}", path.ToString());
        ...
        {
            object path = @"D:\OPMTest\Template\Mẫu 1. Đề nghị mở bảo lãnh thực hiện hợp đồng.docx";
            object filename = string.Format(@"D:\OPMTest\{0}\Mẫu 1. Đề nghị mở bảo lãnh thực hiện hợp đồng {0}.docx", contractId.Trim().Replace('/', '-'));
            string strPODirectory = string.Format(@"D:\OPMTest\{0}", contractId.Trim().Replace('/', '-'));
            if (!Directory.Exists(strPODirectory))
            {
                Directory.CreateDirectory(strPODirectory);
            }

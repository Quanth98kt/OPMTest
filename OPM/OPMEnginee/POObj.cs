...
namespace OPM.OPMEnginee
{
    public partial class POObj : ContractObj
    {
            ...
            set
            {
                ...
                try
                {
                    ...
                    if (table.Rows.Count > 0)
                    {
                        ...
                        POConfirmId = (row["POConfirmId"] == null || row["POConfirmId"] == DBNull.Value) ? "XXXX/ANSV-DO" : row["POConfirmId"].ToString();
                        ...
                        POAdvanceId = (row["POAdvanceId"] == null || row["POAdvanceId"] == DBNull.Value) ? "XXXX/ANSV-TCKT" : row["POAdvanceId"].ToString();
                        ...
                        POAdvanceRequestId = (row["POAdvanceRequestId"] == null || row["POAdvanceRequestId"] == DBNull.Value) ? "XXXX/ANSV-TCKT" : row["POAdvanceRequestId"].ToString();
                        ...
                        POAdjustmentConfirmationNumber = (row["POAdjustmentConfirmationNumber"] == null || row["POAdjustmentConfirmationNumber"] == DBNull.Value) ? "XXXX/ANSV-DO" : row["POAdjustmentConfirmationNumber"].ToString();
                        POAdjustmentConfirmationDate = (row["POAdjustmentConfirmationDate"] == null || row["POAdjustmentConfirmationDate"] == DBNull.Value) ? DateTime.Now : (DateTime)row["POAdjustmentConfirmationDate"];
                        ...
                        POInvoicingRequestDate = (row["POInvoicingRequestDate"] == null || row["POInvoicingRequestDate"] == DBNull.Value) ? DateTime.Now : (DateTime)row["POInvoicingRequestDate"];
                        check_POGuaranteeDate = (row["check_POGuaranteeDate"] == null || row["check_POGuaranteeDate"] == DBNull.Value) ? 0 : (int)row["check_POGuaranteeDate"];
                        check_POAdvanceGuaranteeCreatedDate = (row["check_POAdvanceGuaranteeCreatedDate"] == null || row["check_POAdvanceGuaranteeCreatedDate"] == DBNull.Value) ? 0 : (int)row["check_POAdvanceGuaranteeCreatedDate"];
                        check_POOfferToGuaranteePOWarrantyDate = (row["check_POOfferToGuaranteePOWarrantyDate"] == null || row["check_POOfferToGuaranteePOWarrantyDate"] == DBNull.Value) ? 0 : (int)row["check_POOfferToGuaranteePOWarrantyDate"];
                        check_POConfirmRequestDeadline = (row["check_POConfirmRequestDeadline"] == null || row["check_POConfirmRequestDeadline"] == DBNull.Value) ? 0 : (int)row["check_POConfirmRequestDeadline"];
                    }
                }
                catch (Exception e)
                {
                    MessageBox.Show("Lỗi khi kết nối bảng PO trong CSDL " + e.Message + e.StackTrace);
                }
            }
        }
        ...
        public DateTime POInvoicingRequestDate { get; set; } = DateTime.Now;
        public int check_POGuaranteeDate { get; set; } = 0;
        public int check_POAdvanceGuaranteeCreatedDate { get; set; } = 0;
        public int check_POOfferToGuaranteePOWarrantyDate { get; set; } = 0;
        public int check_POConfirmRequestDeadline { get; set; } = 0;
        ...
        public static bool PONames(string contractId, string PoName)
        {
            string query = string.Format("SELECT * FROM dbo.PO WHERE ContractId = '{0}' and POName = '{1}'", contractId, PoName);
            DataTable table = OPMDBHandler.ExecuteQuery(query);
            return table.Rows.Count > 0;
        }
